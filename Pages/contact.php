...
<span class="error">* <?php echo $data['salErr'] ?></span></div>
...
<span class="error">* <?php echo $data['namErr'];?></span></div>
...
<span class="error">* <?php echo $data['comprefErr'];?></span></div>
...
<span class="error">* <?php echo $data['messErr'] ?></div>
